...
import '../painters/circular_maze_painter.dart';
import '../theme/app_colors.dart';

class CircularGameScreen extends StatefulWidget {
  ...
  @override
  State<CircularGameScreen> createState() => _CircularGameScreenState();
}

class _CircularGameScreenState extends State<CircularGameScreen>
    with SingleTickerProviderStateMixin {
  static const double _horizontalPadding = 32.0;
  static const int _levelTimeMs = 60000;
  static const double _keyAccel = 6.0;

  late CircularGameController _controller;
  late Ticker _ticker;
  ...
  void initState() {
    super.initState();
    _controller = CircularGameController(
  ...
  Widget _buildMazeStage(AppColors c) {
    return LayoutBuilder(
      builder: (context, constraints) {
        final width = constraints.maxWidth - (_horizontalPadding * 2);
        final size = width;
        _controller.setBounds(width: size, height: size);
